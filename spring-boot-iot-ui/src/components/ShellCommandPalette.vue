...
.command-palette__panel { position: relative; z-index: 1; width: min(48rem, calc(100vw - 2rem)); max-height: 80vh; overflow-y: auto; padding: 1rem; border-radius: 1.2rem; border: 1px solid rgba(226, 232, 240, 0.88); background: rgba(255, 255, 255, 0.96); box-shadow: var(--shadow-command-panel); }
...
.command-palette__search { display: grid; grid-template-columns: auto 1fr; align-items: center; min-height: 3rem; border: 1px solid rgba(201, 211, 225, 0.92); border-radius: var(--radius-pill); background: linear-gradient(180deg, rgba(251, 252, 254, 0.98), rgba(246, 248, 252, 0.98)); transition: border-color 160ms ease, box-shadow 160ms ease; }
...
.command-palette__icon::after { content: ''; position: absolute; width: 0.36rem; height: 1.8px; background: #8ea0ba; border-radius: var(--radius-pill); transform: translate(0.34rem, 0.34rem) rotate(45deg); }
...
.command-palette__close { min-height: 2.75rem; padding: 0 0.9rem; border: 1px solid rgba(208, 216, 227, 0.96); border-radius: var(--radius-pill); background: linear-gradient(180deg, #ffffff, #f7f9fc); color: var(--text-secondary); font-weight: 700; }
...
.command-palette__item:hover { border-color: color-mix(in srgb, var(--brand) 18%, white); box-shadow: var(--shadow-command-item-hover); transform: translateY(-1px); }
