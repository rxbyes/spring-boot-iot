  ...
  <StandardPageShell class="linkage-rule-view">
    ...
    >
      <template #header-actions>
        <StandardButton action="add" v-permission="'risk:linkage-rule:edit'" @click="handleAdd">新增规则</StandardButton>
      </template>
      ...
      >
        ...
        <div v-else-if="!loading" class="standard-list-empty-state">
          ...
          <div class="standard-list-empty-state__actions">
            ...
            <StandardButton v-else action="add" v-permission="'risk:linkage-rule:edit'" @click="handleAdd">新增规则</StandardButton>
          </div>
        </div>
      </div>
