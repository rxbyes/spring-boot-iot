...
describe('ProductBusinessWorkbenchDrawer', () => {
  it('renders the workbench as a director-journal masthead with a title column, scale panel, and thin tab strip', () => {
    ...
    expect(wrapper.find('.product-business-workbench__journal-summary').text()).not.toContain('治理')
    ...
    expect(wrapper.find('.product-business-workbench__meta-line').text()).toContain('demo-product')
    expect(wrapper.find('.product-business-workbench__meta-line').text()).toContain('mqtt-json')
    expect(wrapper.find('.product-business-workbench__meta-line').text()).toContain('直连设备')
    expect(wrapper.find('.product-business-workbench__meta-line').text()).toContain('JSON')
