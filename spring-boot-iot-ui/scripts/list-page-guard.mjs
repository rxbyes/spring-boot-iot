...
function scanRequiredUsage(filePath, content, errors) {
  const requirements = [
    { pattern: /<StandardListFilterHeader\b/, message: '纳管页必须使用 StandardListFilterHeader。' },
    { pattern: /<StandardTableToolbar\b/, message: '纳管页必须使用 StandardTableToolbar。' },
    { pattern: /<StandardPagination\b/, message: '纳管页分页必须使用 StandardPagination。' }
  ]
