...
public class GovernancePermissionMatrixServiceImpl implements GovernancePermissionMatrixService {
    ...
    public List<GovernancePermissionMatrixItemVO> listMatrix() {
        return List.of(
                ...
                item("PROTOCOL_GOVERNANCE", "协议治理", "PROTOCOL_FAMILY_PUBLISH", "协议族定义发布",
                        GovernancePermissionCodes.PROTOCOL_GOVERNANCE_EDIT, GovernancePermissionCodes.PROTOCOL_GOVERNANCE_APPROVE,
                        OPERATOR_ROLES, APPROVER_ROLES, true, "protocol-family-publish"),
                item("PROTOCOL_GOVERNANCE", "协议治理", "PROTOCOL_FAMILY_ROLLBACK", "协议族定义回滚",
                        GovernancePermissionCodes.PROTOCOL_GOVERNANCE_EDIT, GovernancePermissionCodes.PROTOCOL_GOVERNANCE_APPROVE,
                        OPERATOR_ROLES, APPROVER_ROLES, true, "protocol-family-rollback"),
                item("PROTOCOL_GOVERNANCE", "协议治理", "PROTOCOL_DECRYPT_PROFILE_PUBLISH", "协议解密档案发布",
                        GovernancePermissionCodes.PROTOCOL_GOVERNANCE_EDIT, GovernancePermissionCodes.PROTOCOL_GOVERNANCE_APPROVE,
                        OPERATOR_ROLES, APPROVER_ROLES, true, "protocol-decrypt-profile-publish"),
                item("PROTOCOL_GOVERNANCE", "协议治理", "PROTOCOL_DECRYPT_PROFILE_ROLLBACK", "协议解密档案回滚",
                        GovernancePermissionCodes.PROTOCOL_GOVERNANCE_EDIT, GovernancePermissionCodes.PROTOCOL_GOVERNANCE_APPROVE,
                        OPERATOR_ROLES, APPROVER_ROLES, true, "protocol-decrypt-profile-rollback"),
