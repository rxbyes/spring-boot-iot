...
3. 首次升级到当前验收基线时，按 [docs/03-database.md](docs/03-database.md) 依次执行 `sql/upgrade/` 下的升级脚本，至少包含 `20260316_phase4_task3_risk_monitoring_schema_sync.sql`、`20260316_phase4_real_env_schema_alignment.sql`、`20260316_phase4_task10_dynamic_menu_auth.sql` 与 `20260316_iot_message_log_view.sql`
4. 启动后端：
   ```bash
