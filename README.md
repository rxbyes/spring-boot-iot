...
- 平台治理：组织、账号中心、用户、角色、菜单、区域、字典、治理任务台、治理运维台、治理审批台、通知渠道、站内消息、帮助文档、审计中心
