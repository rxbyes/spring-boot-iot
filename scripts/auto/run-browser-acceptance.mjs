...
function printHelp() {
  process.stdout.write(
    [
      'Usage:',
      '  node scripts/auto/run-browser-acceptance.mjs [--dry-run] [--no-append-issues] [--update-baseline] [--plan=config/automation/sample-web-smoke-plan.json] [--scopes=delivery,baseline] [--fail-scopes=delivery]',
      '',
      'Options:',
