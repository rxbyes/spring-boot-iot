...
| 链路验证中心 | `/reporting` / `ReportWorkbenchView.vue` | `spring-boot-iot-ui/src/api/iot.ts` | `POST /api/message/http/report` | `iot_message_log`、`iot_device_property`、`iot_device` | 已接真实后端，当前以前端“链路验证中心”方式承接 HTTP 上报验证主链路 |
