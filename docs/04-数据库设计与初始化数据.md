...
- `2026-04-09` 起，`sql/init-data.sql` 额外内置平台治理页面菜单 `93003022 / system:governance-approval / /governance-approval` 与 `93003023 / system:governance-security / /governance-security`，分别用于显式暴露治理审批台、权限与密钥治理页。
- 字段：
