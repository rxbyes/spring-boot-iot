...
- 主真相：直接承载业务当前态与主链路写入，例如 `iot_product`、`iot_product_model`、`iot_device`、`risk_point`、`sys_governance_approval_order`、`iot_protocol_family_definition`、`iot_protocol_decrypt_profile`、`iot_protocol_template_definition`。
