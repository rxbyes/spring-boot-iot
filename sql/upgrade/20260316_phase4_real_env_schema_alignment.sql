...
ALTER TABLE sys_audit_log ADD COLUMN IF NOT EXISTS trace_id VARCHAR(64) DEFAULT NULL COMMENT 'trace id';
ALTER TABLE sys_audit_log ADD COLUMN IF NOT EXISTS device_code VARCHAR(64) DEFAULT NULL COMMENT 'device code';
ALTER TABLE sys_audit_log ADD COLUMN IF NOT EXISTS product_key VARCHAR(64) DEFAULT NULL COMMENT 'product key';
...
ALTER TABLE sys_audit_log ADD COLUMN IF NOT EXISTS error_code VARCHAR(64) DEFAULT NULL COMMENT 'error code';
ALTER TABLE sys_audit_log ADD COLUMN IF NOT EXISTS exception_class VARCHAR(255) DEFAULT NULL COMMENT 'exception class';
...
ALTER TABLE iot_device_message_log ADD COLUMN IF NOT EXISTS trace_id VARCHAR(64) DEFAULT NULL COMMENT 'trace id';
ALTER TABLE iot_device_message_log ADD COLUMN IF NOT EXISTS device_code VARCHAR(64) DEFAULT NULL COMMENT 'device code';
ALTER TABLE iot_device_message_log ADD COLUMN IF NOT EXISTS product_key VARCHAR(64) DEFAULT NULL COMMENT 'product key';
