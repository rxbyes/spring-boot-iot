...
INSERT INTO sys_menu (
    ...
    (93002041, 1, 93002004, '维护阈值策略', 'risk:rule-definition:write', '', '', '', '{"caption":"阈值策略新增、编辑、删除按钮权限"}', 3241, 2, 2, '', 'risk:rule-definition:write', 3241, 1, 1, 1, NOW(), 1, NOW(), 0),
    (93002042, 1, 93002005, '维护联动编排', 'risk:linkage-rule:write', '', '', '', '{"caption":"联动编排新增、编辑、删除按钮权限"}', 3341, 2, 2, '', 'risk:linkage-rule:write', 3341, 1, 1, 1, NOW(), 1, NOW(), 0),
    (93002043, 1, 93002006, '维护应急预案', 'risk:emergency-plan:write', '', '', '', '{"caption":"应急预案新增、编辑、删除按钮权限"}', 3441, 2, 2, '', 'risk:emergency-plan:write', 3441, 1, 1, 1, NOW(), 1, NOW(), 0),
